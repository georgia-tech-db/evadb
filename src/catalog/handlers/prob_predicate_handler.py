...
class ProbPredicateHandler:
    ...
    def addProbabilisticFilter(self, name: str, reduction_rate: float,
                               filter_cost: float, accuracy: float, udf_cost: float, model_type: str) -> None:
        """
    ...
    def updateProbabilisticFilter(self, name: str, reduction_rate: float,
                                  filterCost: float, accuracy: float, udf_cost: float, model_type: str) -> None:
        """
