...
class EvaParserVisitor(frameQLParserVisitor):
    ...
    def visitTransactionStatement(
            self, ctx: frameQLParser.TransactionStatementContext):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by frameQLParser#replicationStatement.
    def visitReplicationStatement(
            self, ctx: frameQLParser.ReplicationStatementContext):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by frameQLParser#preparedStatement.
    def visitPreparedStatement(
            self, ctx: frameQLParser.PreparedStatementContext):
        return self.visitChildren(ctx)
    ...
    def visitCreateLogfileGroup(
            self, ctx: frameQLParser.CreateLogfileGroupContext):
        return self.visitChildren(ctx)
    ...
    def visitQueryCreateTable(
            self,
            ctx: frameQLParser.QueryCreateTableContext):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by frameQLParser#columnCreateTable.
    def visitColumnCreateTable(
            self, ctx: frameQLParser.ColumnCreateTableContext):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by frameQLParser#createTablespaceInnodb.
    def visitCreateTablespaceInnodb(
            self, ctx: frameQLParser.CreateTablespaceInnodbContext):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by frameQLParser#createTablespaceNdb.
    def visitCreateTablespaceNdb(
            self, ctx: frameQLParser.CreateTablespaceNdbContext):
        return self.visitChildren(ctx)
    ...
    def visitCreateDatabaseOption(
            self, ctx: frameQLParser.CreateDatabaseOptionContext):
        return self.visitChildren(ctx)
    ...
    def visitIntervalSchedule(
            self,
            ctx: frameQLParser.IntervalScheduleContext):
        return self.visitChildren(ctx)
    ...
    def visitProcedureParameter(
            self, ctx: frameQLParser.ProcedureParameterContext):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by frameQLParser#functionParameter.
    def visitFunctionParameter(
    ...
    def visitReferenceColumnConstraint(
            self, ctx: frameQLParser.ReferenceColumnConstraintContext):
        return self.visitChildren(ctx)
    ...
    # Visit a parse tree produced by
    # frameQLParser#serialDefaultColumnConstraint.
    def visitSerialDefaultColumnConstraint(
            self, ctx: frameQLParser.SerialDefaultColumnConstraintContext):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by frameQLParser#primaryKeyTableConstraint.
    def visitPrimaryKeyTableConstraint(
    ...
    def visitUniqueKeyTableConstraint(
            self, ctx: frameQLParser.UniqueKeyTableConstraintContext):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by frameQLParser#foreignKeyTableConstraint.
    def visitForeignKeyTableConstraint(
            self, ctx: frameQLParser.ForeignKeyTableConstraintContext):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by frameQLParser#checkTableConstraint.
    def visitCheckTableConstraint(
            self, ctx: frameQLParser.CheckTableConstraintContext):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by frameQLParser#referenceDefinition.
    def visitReferenceDefinition(
            self, ctx: frameQLParser.ReferenceDefinitionContext):
        return self.visitChildren(ctx)
    ...
    def visitPartitionDefinerAtom(
            self, ctx: frameQLParser.PartitionDefinerAtomContext):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by frameQLParser#partitionDefinerVector.
    def visitPartitionDefinerVector(
            self, ctx: frameQLParser.PartitionDefinerVectorContext):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by frameQLParser#subpartitionDefinition.
    def visitSubpartitionDefinition(
            self, ctx: frameQLParser.SubpartitionDefinitionContext):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by frameQLParser#partitionOptionEngine.
    def visitPartitionOptionEngine(
            self, ctx: frameQLParser.PartitionOptionEngineContext):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by frameQLParser#partitionOptionComment.
    def visitPartitionOptionComment(
            self, ctx: frameQLParser.PartitionOptionCommentContext):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by
    # frameQLParser#partitionOptionDataDirectory.
    def visitPartitionOptionDataDirectory(
            self, ctx: frameQLParser.PartitionOptionDataDirectoryContext):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by
    # frameQLParser#partitionOptionIndexDirectory.
    def visitPartitionOptionIndexDirectory(
            self, ctx: frameQLParser.PartitionOptionIndexDirectoryContext):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by frameQLParser#partitionOptionMaxRows.
    def visitPartitionOptionMaxRows(
            self, ctx: frameQLParser.PartitionOptionMaxRowsContext):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by frameQLParser#partitionOptionMinRows.
    def visitPartitionOptionMinRows(
            self, ctx: frameQLParser.PartitionOptionMinRowsContext):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by frameQLParser#partitionOptionTablespace.
    def visitPartitionOptionTablespace(
            self, ctx: frameQLParser.PartitionOptionTablespaceContext):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by frameQLParser#partitionOptionNodeGroup.
    def visitPartitionOptionNodeGroup(
            self, ctx: frameQLParser.PartitionOptionNodeGroupContext):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by frameQLParser#alterSimpleDatabase.
    def visitAlterSimpleDatabase(
            self, ctx: frameQLParser.AlterSimpleDatabaseContext):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by frameQLParser#alterUpgradeName.
    def visitAlterUpgradeName(
            self,
            ctx: frameQLParser.AlterUpgradeNameContext):
        return self.visitChildren(ctx)
    ...
    def visitAlterLogfileGroup(
            self, ctx: frameQLParser.AlterLogfileGroupContext):
        return self.visitChildren(ctx)
    ...
    def visitAlterByTableOption(
            self, ctx: frameQLParser.AlterByTableOptionContext):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by frameQLParser#alterByAddColumn.
    def visitAlterByAddColumn(
            self,
            ctx: frameQLParser.AlterByAddColumnContext):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by frameQLParser#alterByAddColumns.
    def visitAlterByAddColumns(
            self, ctx: frameQLParser.AlterByAddColumnsContext):
        return self.visitChildren(ctx)
    ...
    def visitAlterByAddPrimaryKey(
            self, ctx: frameQLParser.AlterByAddPrimaryKeyContext):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by frameQLParser#alterByAddUniqueKey.
    def visitAlterByAddUniqueKey(
            self, ctx: frameQLParser.AlterByAddUniqueKeyContext):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by frameQLParser#alterByAddSpecialIndex.
    def visitAlterByAddSpecialIndex(
            self, ctx: frameQLParser.AlterByAddSpecialIndexContext):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by frameQLParser#alterByAddForeignKey.
    def visitAlterByAddForeignKey(
            self, ctx: frameQLParser.AlterByAddForeignKeyContext):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by
    # frameQLParser#alterByAddCheckTableConstraint.
    def visitAlterByAddCheckTableConstraint(
            self, ctx: frameQLParser.AlterByAddCheckTableConstraintContext):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by frameQLParser#alterBySetAlgorithm.
    def visitAlterBySetAlgorithm(
            self, ctx: frameQLParser.AlterBySetAlgorithmContext):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by frameQLParser#alterByChangeDefault.
    def visitAlterByChangeDefault(
            self, ctx: frameQLParser.AlterByChangeDefaultContext):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by frameQLParser#alterByChangeColumn.
    def visitAlterByChangeColumn(
            self, ctx: frameQLParser.AlterByChangeColumnContext):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by frameQLParser#alterByRenameColumn.
    def visitAlterByRenameColumn(
            self, ctx: frameQLParser.AlterByRenameColumnContext):
        return self.visitChildren(ctx)
    ...
    def visitAlterByModifyColumn(
            self, ctx: frameQLParser.AlterByModifyColumnContext):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by frameQLParser#alterByDropColumn.
    def visitAlterByDropColumn(
            self, ctx: frameQLParser.AlterByDropColumnContext):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by frameQLParser#alterByDropPrimaryKey.
    def visitAlterByDropPrimaryKey(
            self, ctx: frameQLParser.AlterByDropPrimaryKeyContext):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by frameQLParser#alterByDropIndex.
    def visitAlterByDropIndex(
            self,
            ctx: frameQLParser.AlterByDropIndexContext):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by frameQLParser#alterByDropForeignKey.
    def visitAlterByDropForeignKey(
            self, ctx: frameQLParser.AlterByDropForeignKeyContext):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by frameQLParser#alterByDisableKeys.
    def visitAlterByDisableKeys(
            self, ctx: frameQLParser.AlterByDisableKeysContext):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by frameQLParser#alterByEnableKeys.
    def visitAlterByEnableKeys(
            self, ctx: frameQLParser.AlterByEnableKeysContext):
        return self.visitChildren(ctx)
    ...
    def visitAlterByConvertCharset(
            self, ctx: frameQLParser.AlterByConvertCharsetContext):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by frameQLParser#alterByDefaultCharset.
    def visitAlterByDefaultCharset(
            self, ctx: frameQLParser.AlterByDefaultCharsetContext):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by frameQLParser#alterByDiscardTablespace.
    def visitAlterByDiscardTablespace(
            self, ctx: frameQLParser.AlterByDiscardTablespaceContext):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by frameQLParser#alterByImportTablespace.
    def visitAlterByImportTablespace(
            self, ctx: frameQLParser.AlterByImportTablespaceContext):
        return self.visitChildren(ctx)
    ...
    def visitAlterByAddPartition(
            self, ctx: frameQLParser.AlterByAddPartitionContext):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by frameQLParser#alterByDropPartition.
    def visitAlterByDropPartition(
            self, ctx: frameQLParser.AlterByDropPartitionContext):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by frameQLParser#alterByDiscardPartition.
    def visitAlterByDiscardPartition(
            self, ctx: frameQLParser.AlterByDiscardPartitionContext):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by frameQLParser#alterByImportPartition.
    def visitAlterByImportPartition(
            self, ctx: frameQLParser.AlterByImportPartitionContext):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by frameQLParser#alterByTruncatePartition.
    def visitAlterByTruncatePartition(
            self, ctx: frameQLParser.AlterByTruncatePartitionContext):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by frameQLParser#alterByCoalescePartition.
    def visitAlterByCoalescePartition(
            self, ctx: frameQLParser.AlterByCoalescePartitionContext):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by frameQLParser#alterByReorganizePartition.
    def visitAlterByReorganizePartition(
            self, ctx: frameQLParser.AlterByReorganizePartitionContext):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by frameQLParser#alterByExchangePartition.
    def visitAlterByExchangePartition(
            self, ctx: frameQLParser.AlterByExchangePartitionContext):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by frameQLParser#alterByAnalyzePartitiion.
    def visitAlterByAnalyzePartitiion(
            self, ctx: frameQLParser.AlterByAnalyzePartitiionContext):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by frameQLParser#alterByCheckPartition.
    def visitAlterByCheckPartition(
            self, ctx: frameQLParser.AlterByCheckPartitionContext):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by frameQLParser#alterByOptimizePartition.
    def visitAlterByOptimizePartition(
    ...
    def visitAlterByRebuildPartition(
            self, ctx: frameQLParser.AlterByRebuildPartitionContext):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by frameQLParser#alterByRepairPartition.
    def visitAlterByRepairPartition(
            self, ctx: frameQLParser.AlterByRepairPartitionContext):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by frameQLParser#alterByRemovePartitioning.
    def visitAlterByRemovePartitioning(
            self, ctx: frameQLParser.AlterByRemovePartitioningContext):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by frameQLParser#alterByUpgradePartitioning.
    def visitAlterByUpgradePartitioning(
            self, ctx: frameQLParser.AlterByUpgradePartitioningContext):
        return self.visitChildren(ctx)
    ...
    def visitDropLogfileGroup(
            self,
            ctx: frameQLParser.DropLogfileGroupContext):
        return self.visitChildren(ctx)
    ...
    def visitRenameTableClause(
            self, ctx: frameQLParser.RenameTableClauseContext):
        return self.visitChildren(ctx)
    ...
    def visitHandlerStatement(
            self,
            ctx: frameQLParser.HandlerStatementContext):
        return self.visitChildren(ctx)
    ...
    def visitLoadDataStatement(
            self, ctx: frameQLParser.LoadDataStatementContext):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by frameQLParser#loadXmlStatement.
    def visitLoadXmlStatement(
            self,
            ctx: frameQLParser.LoadXmlStatementContext):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by frameQLParser#replaceStatement.
    def visitReplaceStatement(
            self,
            ctx: frameQLParser.ReplaceStatementContext):
        return self.visitChildren(ctx)
    ...
    def visitParenthesisSelect(
            self, ctx: frameQLParser.ParenthesisSelectContext):
        return self.visitChildren(ctx)
    ...
    def visitUnionParenthesisSelect(
            self, ctx: frameQLParser.UnionParenthesisSelectContext):
        return self.visitChildren(ctx)
    ...
    def visitInsertStatementValue(
            self, ctx: frameQLParser.InsertStatementValueContext):
        return self.visitChildren(ctx)
    ...
    def visitSingleDeleteStatement(
            self, ctx: frameQLParser.SingleDeleteStatementContext):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by frameQLParser#multipleDeleteStatement.
    def visitMultipleDeleteStatement(
            self, ctx: frameQLParser.MultipleDeleteStatementContext):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by frameQLParser#handlerOpenStatement.
    def visitHandlerOpenStatement(
            self, ctx: frameQLParser.HandlerOpenStatementContext):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by frameQLParser#handlerReadIndexStatement.
    def visitHandlerReadIndexStatement(
            self, ctx: frameQLParser.HandlerReadIndexStatementContext):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by frameQLParser#handlerReadStatement.
    def visitHandlerReadStatement(
            self, ctx: frameQLParser.HandlerReadStatementContext):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by frameQLParser#handlerCloseStatement.
    def visitHandlerCloseStatement(
            self, ctx: frameQLParser.HandlerCloseStatementContext):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by frameQLParser#singleUpdateStatement.
    def visitSingleUpdateStatement(
            self, ctx: frameQLParser.SingleUpdateStatementContext):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by frameQLParser#multipleUpdateStatement.
    def visitMultipleUpdateStatement(
            self, ctx: frameQLParser.MultipleUpdateStatementContext):
        return self.visitChildren(ctx)
    ...
    def visitOrderByExpression(
            self, ctx: frameQLParser.OrderByExpressionContext):
        return self.visitChildren(ctx)
    ...
    def visitTableSourceNested(
            self, ctx: frameQLParser.TableSourceNestedContext):
        return self.visitChildren(ctx)
    ...
    def visitSubqueryTableItem(
            self, ctx: frameQLParser.SubqueryTableItemContext):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by frameQLParser#tableSourcesItem.
    def visitTableSourcesItem(
            self,
            ctx: frameQLParser.TableSourcesItemContext):
        return self.visitChildren(ctx)
    ...
    def visitQueryExpressionNointo(
            self, ctx: frameQLParser.QueryExpressionNointoContext):
        return self.visitChildren(ctx)
    ...
    def visitQuerySpecificationNointo(
            self, ctx: frameQLParser.QuerySpecificationNointoContext):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by frameQLParser#unionParenthesis.
    def visitUnionParenthesis(
            self,
            ctx: frameQLParser.UnionParenthesisContext):
        return self.visitChildren(ctx)
    ...
    def visitSelectStarElement(
            self, ctx: frameQLParser.SelectStarElementContext):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by frameQLParser#selectColumnElement.
    def visitSelectColumnElement(
            self, ctx: frameQLParser.SelectColumnElementContext):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by frameQLParser#selectFunctionElement.
    def visitSelectFunctionElement(
            self, ctx: frameQLParser.SelectFunctionElementContext):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by frameQLParser#selectExpressionElement.
    def visitSelectExpressionElement(
            self, ctx: frameQLParser.SelectExpressionElementContext):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by frameQLParser#errorTolerenceExpression.
    def visitErrorTolerenceExpression(
            self, ctx: frameQLParser.ErrorTolerenceExpressionContext):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by frameQLParser#confLevelExpression.
    def visitConfLevelExpression(
            self, ctx: frameQLParser.ConfLevelExpressionContext):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by frameQLParser#selectIntoVariables.
    def visitSelectIntoVariables(
            self, ctx: frameQLParser.SelectIntoVariablesContext):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by frameQLParser#selectIntoDumpFile.
    def visitSelectIntoDumpFile(
            self, ctx: frameQLParser.SelectIntoDumpFileContext):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by frameQLParser#selectIntoTextFile.
    def visitSelectIntoTextFile(
            self, ctx: frameQLParser.SelectIntoTextFileContext):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by frameQLParser#selectFieldsInto.
    def visitSelectFieldsInto(
            self,
            ctx: frameQLParser.SelectFieldsIntoContext):
        return self.visitChildren(ctx)
    ...
    def visitStartTransaction(
            self,
            ctx: frameQLParser.StartTransactionContext):
        return self.visitChildren(ctx)
    ...
    def visitSavepointStatement(
            self, ctx: frameQLParser.SavepointStatementContext):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by frameQLParser#rollbackStatement.
    def visitRollbackStatement(
            self, ctx: frameQLParser.RollbackStatementContext):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by frameQLParser#releaseStatement.
    def visitReleaseStatement(
            self,
            ctx: frameQLParser.ReleaseStatementContext):
        return self.visitChildren(ctx)
    ...
    def visitLockTableElement(
            self,
            ctx: frameQLParser.LockTableElementContext):
        return self.visitChildren(ctx)
    ...
    def visitTransactionOption(
            self, ctx: frameQLParser.TransactionOptionContext):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by frameQLParser#transactionLevel.
    def visitTransactionLevel(
            self,
            ctx: frameQLParser.TransactionLevelContext):
        return self.visitChildren(ctx)
    ...
    def visitChangeReplicationFilter(
            self, ctx: frameQLParser.ChangeReplicationFilterContext):
        return self.visitChildren(ctx)
    ...
    def visitStartGroupReplication(
            self, ctx: frameQLParser.StartGroupReplicationContext):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by frameQLParser#stopGroupReplication.
    def visitStopGroupReplication(
            self, ctx: frameQLParser.StopGroupReplicationContext):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by frameQLParser#masterStringOption.
    def visitMasterStringOption(
            self, ctx: frameQLParser.MasterStringOptionContext):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by frameQLParser#masterDecimalOption.
    def visitMasterDecimalOption(
            self, ctx: frameQLParser.MasterDecimalOptionContext):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by frameQLParser#masterBoolOption.
    def visitMasterBoolOption(
            self,
            ctx: frameQLParser.MasterBoolOptionContext):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by frameQLParser#masterRealOption.
    def visitMasterRealOption(
            self,
            ctx: frameQLParser.MasterRealOptionContext):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by frameQLParser#masterUidListOption.
    def visitMasterUidListOption(
            self, ctx: frameQLParser.MasterUidListOptionContext):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by frameQLParser#stringMasterOption.
    def visitStringMasterOption(
            self, ctx: frameQLParser.StringMasterOptionContext):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by frameQLParser#decimalMasterOption.
    def visitDecimalMasterOption(
            self, ctx: frameQLParser.DecimalMasterOptionContext):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by frameQLParser#boolMasterOption.
    def visitBoolMasterOption(
            self,
            ctx: frameQLParser.BoolMasterOptionContext):
        return self.visitChildren(ctx)
    ...
    def visitIgnoreDbReplication(
            self, ctx: frameQLParser.IgnoreDbReplicationContext):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by frameQLParser#doTableReplication.
    def visitDoTableReplication(
            self, ctx: frameQLParser.DoTableReplicationContext):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by frameQLParser#ignoreTableReplication.
    def visitIgnoreTableReplication(
            self, ctx: frameQLParser.IgnoreTableReplicationContext):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by frameQLParser#wildDoTableReplication.
    def visitWildDoTableReplication(
            self, ctx: frameQLParser.WildDoTableReplicationContext):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by frameQLParser#wildIgnoreTableReplication.
    def visitWildIgnoreTableReplication(
            self, ctx: frameQLParser.WildIgnoreTableReplicationContext):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by frameQLParser#rewriteDbReplication.
    def visitRewriteDbReplication(
            self, ctx: frameQLParser.RewriteDbReplicationContext):
        return self.visitChildren(ctx)
    ...
    def visitGtidsUntilOption(
            self,
            ctx: frameQLParser.GtidsUntilOptionContext):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by frameQLParser#masterLogUntilOption.
    def visitMasterLogUntilOption(
            self, ctx: frameQLParser.MasterLogUntilOptionContext):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by frameQLParser#relayLogUntilOption.
    def visitRelayLogUntilOption(
            self, ctx: frameQLParser.RelayLogUntilOptionContext):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by frameQLParser#sqlGapsUntilOption.
    def visitSqlGapsUntilOption(
            self, ctx: frameQLParser.SqlGapsUntilOptionContext):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by frameQLParser#userConnectionOption.
    def visitUserConnectionOption(
            self, ctx: frameQLParser.UserConnectionOptionContext):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by frameQLParser#passwordConnectionOption.
    def visitPasswordConnectionOption(
            self, ctx: frameQLParser.PasswordConnectionOptionContext):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by frameQLParser#defaultAuthConnectionOption.
    def visitDefaultAuthConnectionOption(
            self, ctx: frameQLParser.DefaultAuthConnectionOptionContext):
        return self.visitChildren(ctx)
    ...
    def visitXaStartTransaction(
            self, ctx: frameQLParser.XaStartTransactionContext):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by frameQLParser#xaEndTransaction.
    def visitXaEndTransaction(
            self,
            ctx: frameQLParser.XaEndTransactionContext):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by frameQLParser#xaPrepareStatement.
    def visitXaPrepareStatement(
            self, ctx: frameQLParser.XaPrepareStatementContext):
        return self.visitChildren(ctx)
    ...
    def visitPrepareStatement(
            self,
            ctx: frameQLParser.PrepareStatementContext):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by frameQLParser#executeStatement.
    def visitExecuteStatement(
            self,
            ctx: frameQLParser.ExecuteStatementContext):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by frameQLParser#deallocatePrepare.
    def visitDeallocatePrepare(
            self, ctx: frameQLParser.DeallocatePrepareContext):
        return self.visitChildren(ctx)
    ...
    def visitIterateStatement(
            self,
            ctx: frameQLParser.IterateStatementContext):
        return self.visitChildren(ctx)
    ...
    def visitDeclareCondition(
            self,
            ctx: frameQLParser.DeclareConditionContext):
        return self.visitChildren(ctx)
    ...
    def visitHandlerConditionCode(
            self, ctx: frameQLParser.HandlerConditionCodeContext):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by frameQLParser#handlerConditionState.
    def visitHandlerConditionState(
            self, ctx: frameQLParser.HandlerConditionStateContext):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by frameQLParser#handlerConditionName.
    def visitHandlerConditionName(
            self, ctx: frameQLParser.HandlerConditionNameContext):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by frameQLParser#handlerConditionWarning.
    def visitHandlerConditionWarning(
            self, ctx: frameQLParser.HandlerConditionWarningContext):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by frameQLParser#handlerConditionNotfound.
    def visitHandlerConditionNotfound(
            self, ctx: frameQLParser.HandlerConditionNotfoundContext):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by frameQLParser#handlerConditionException.
    def visitHandlerConditionException(
            self, ctx: frameQLParser.HandlerConditionExceptionContext):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by frameQLParser#procedureSqlStatement.
    def visitProcedureSqlStatement(
            self, ctx: frameQLParser.ProcedureSqlStatementContext):
        return self.visitChildren(ctx)
    ...
    def visitAlterUserMysqlV56(
            self, ctx: frameQLParser.AlterUserMysqlV56Context):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by frameQLParser#alterUserMysqlV57.
    def visitAlterUserMysqlV57(
            self, ctx: frameQLParser.AlterUserMysqlV57Context):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by frameQLParser#createUserMysqlV56.
    def visitCreateUserMysqlV56(
            self, ctx: frameQLParser.CreateUserMysqlV56Context):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by frameQLParser#createUserMysqlV57.
    def visitCreateUserMysqlV57(
            self, ctx: frameQLParser.CreateUserMysqlV57Context):
        return self.visitChildren(ctx)
    ...
    def visitSetPasswordStatement(
            self, ctx: frameQLParser.SetPasswordStatementContext):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by frameQLParser#userSpecification.
    def visitUserSpecification(
            self, ctx: frameQLParser.UserSpecificationContext):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by frameQLParser#passwordAuthOption.
    def visitPasswordAuthOption(
            self, ctx: frameQLParser.PasswordAuthOptionContext):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by frameQLParser#stringAuthOption.
    def visitStringAuthOption(
            self,
            ctx: frameQLParser.StringAuthOptionContext):
        return self.visitChildren(ctx)
    ...
    def visitSimpleAuthOption(
            self,
            ctx: frameQLParser.SimpleAuthOptionContext):
        return self.visitChildren(ctx)
    ...
    def visitUserResourceOption(
            self, ctx: frameQLParser.UserResourceOptionContext):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by frameQLParser#userPasswordOption.
    def visitUserPasswordOption(
            self, ctx: frameQLParser.UserPasswordOptionContext):
        return self.visitChildren(ctx)
    ...
    def visitCurrentSchemaPriviLevel(
            self, ctx: frameQLParser.CurrentSchemaPriviLevelContext):
        return self.visitChildren(ctx)
    ...
    def visitDefiniteSchemaPrivLevel(
            self, ctx: frameQLParser.DefiniteSchemaPrivLevelContext):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by frameQLParser#definiteFullTablePrivLevel.
    def visitDefiniteFullTablePrivLevel(
            self, ctx: frameQLParser.DefiniteFullTablePrivLevelContext):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by frameQLParser#definiteTablePrivLevel.
    def visitDefiniteTablePrivLevel(
            self, ctx: frameQLParser.DefiniteTablePrivLevelContext):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by frameQLParser#renameUserClause.
    def visitRenameUserClause(
            self,
            ctx: frameQLParser.RenameUserClauseContext):
        return self.visitChildren(ctx)
    ...
    def visitCheckTableOption(
            self,
            ctx: frameQLParser.CheckTableOptionContext):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by frameQLParser#createUdfunction.
    def visitCreateUdfunction(
            self,
            ctx: frameQLParser.CreateUdfunctionContext):
        return self.visitChildren(ctx)
    ...
    def visitShowObjectFilter(
            self,
            ctx: frameQLParser.ShowObjectFilterContext):
        return self.visitChildren(ctx)
    ...
    def visitShowCreateFullIdObject(
            self, ctx: frameQLParser.ShowCreateFullIdObjectContext):
        return self.visitChildren(ctx)
    ...
    def visitShowSchemaFilter(
            self,
            ctx: frameQLParser.ShowSchemaFilterContext):
        return self.visitChildren(ctx)
    ...
    def visitShowCommonEntity(
            self,
            ctx: frameQLParser.ShowCommonEntityContext):
        return self.visitChildren(ctx)
    ...
    def visitShowGlobalInfoClause(
            self, ctx: frameQLParser.ShowGlobalInfoClauseContext):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by frameQLParser#showSchemaEntity.
    def visitShowSchemaEntity(
            self,
            ctx: frameQLParser.ShowSchemaEntityContext):
        return self.visitChildren(ctx)
    ...
    def visitCacheIndexStatement(
            self, ctx: frameQLParser.CacheIndexStatementContext):
        return self.visitChildren(ctx)
    ...
    def visitLoadIndexIntoCache(
            self, ctx: frameQLParser.LoadIndexIntoCacheContext):
        return self.visitChildren(ctx)
    ...
    def visitShutdownStatement(
            self, ctx: frameQLParser.ShutdownStatementContext):
        return self.visitChildren(ctx)
    ...
    def visitSimpleFlushOption(
            self, ctx: frameQLParser.SimpleFlushOptionContext):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by frameQLParser#channelFlushOption.
    def visitChannelFlushOption(
            self, ctx: frameQLParser.ChannelFlushOptionContext):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by frameQLParser#tableFlushOption.
    def visitTableFlushOption(
            self,
            ctx: frameQLParser.TableFlushOptionContext):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by frameQLParser#flushTableOption.
    def visitFlushTableOption(
            self,
            ctx: frameQLParser.FlushTableOptionContext):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by frameQLParser#loadedTableIndexes.
    def visitLoadedTableIndexes(
            self, ctx: frameQLParser.LoadedTableIndexesContext):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by frameQLParser#simpleDescribeStatement.
    def visitSimpleDescribeStatement(
            self, ctx: frameQLParser.SimpleDescribeStatementContext):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by frameQLParser#fullDescribeStatement.
    def visitFullDescribeStatement(
            self, ctx: frameQLParser.FullDescribeStatementContext):
        return self.visitChildren(ctx)
    ...
    def visitDescribeStatements(
            self, ctx: frameQLParser.DescribeStatementsContext):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by frameQLParser#describeConnection.
    def visitDescribeConnection(
            self, ctx: frameQLParser.DescribeConnectionContext):
        return self.visitChildren(ctx)
    ...
    def visitHexadecimalLiteral(
            self, ctx: frameQLParser.HexadecimalLiteralContext):
        return self.visitChildren(ctx)
    ...
    def visitDimensionDataType(
            self, ctx: frameQLParser.DimensionDataTypeContext):
        return self.visitChildren(ctx)
    ...
    def visitCollectionDataType(
            self, ctx: frameQLParser.CollectionDataTypeContext):
        return self.visitChildren(ctx)
    ...
    def visitConvertedDataType(
            self, ctx: frameQLParser.ConvertedDataTypeContext):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by frameQLParser#lengthOneDimension.
    def visitLengthOneDimension(
            self, ctx: frameQLParser.LengthOneDimensionContext):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by frameQLParser#lengthTwoDimension.
    def visitLengthTwoDimension(
            self, ctx: frameQLParser.LengthTwoDimensionContext):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by frameQLParser#lengthTwoOptionalDimension.
    def visitLengthTwoOptionalDimension(
            self, ctx: frameQLParser.LengthTwoOptionalDimensionContext):
        return self.visitChildren(ctx)
    ...
    def visitIndexColumnNames(
            self,
            ctx: frameQLParser.IndexColumnNamesContext):
        return self.visitChildren(ctx)
    ...
    def visitExpressionsWithDefaults(
            self, ctx: frameQLParser.ExpressionsWithDefaultsContext):
        return self.visitChildren(ctx)
    ...
    def visitCurrentTimestamp(
            self,
            ctx: frameQLParser.CurrentTimestampContext):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by frameQLParser#expressionOrDefault.
    def visitExpressionOrDefault(
    ...
    def visitSpecificFunctionCall(
            self, ctx: frameQLParser.SpecificFunctionCallContext):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by frameQLParser#aggregateFunctionCall.
    def visitAggregateFunctionCall(
            self, ctx: frameQLParser.AggregateFunctionCallContext):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by frameQLParser#scalarFunctionCall.
    def visitScalarFunctionCall(
            self, ctx: frameQLParser.ScalarFunctionCallContext):
        return self.visitChildren(ctx)
    ...
    def visitPredicateExpression(
            self, ctx: frameQLParser.PredicateExpressionContext):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by frameQLParser#soundsLikePredicate.
    def visitSoundsLikePredicate(
            self, ctx: frameQLParser.SoundsLikePredicateContext):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by frameQLParser#expressionAtomPredicate.
    def visitExpressionAtomPredicate(
    ...
    # Visit a parse tree produced by
    # frameQLParser#subqueryComparasionPredicate.
    def visitSubqueryComparasionPredicate(
            self, ctx: frameQLParser.SubqueryComparasionPredicateContext):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by frameQLParser#betweenPredicate.
    def visitBetweenPredicate(
            self,
            ctx: frameQLParser.BetweenPredicateContext):
        return self.visitChildren(ctx)
    ...
    def visitUnaryExpressionAtom(
            self, ctx: frameQLParser.UnaryExpressionAtomContext):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by frameQLParser#collateExpressionAtom.
    def visitCollateExpressionAtom(
            self, ctx: frameQLParser.CollateExpressionAtomContext):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by frameQLParser#subqueryExpessionAtom.
    def visitSubqueryExpessionAtom(
            self, ctx: frameQLParser.SubqueryExpessionAtomContext):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by frameQLParser#mysqlVariableExpressionAtom.
    def visitMysqlVariableExpressionAtom(
            self, ctx: frameQLParser.MysqlVariableExpressionAtomContext):
        return self.visitChildren(ctx)
    ...
    def visitNestedRowExpressionAtom(
            self, ctx: frameQLParser.NestedRowExpressionAtomContext):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by frameQLParser#mathExpressionAtom.
    def visitMathExpressionAtom(
            self, ctx: frameQLParser.MathExpressionAtomContext):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by frameQLParser#intervalExpressionAtom.
    def visitIntervalExpressionAtom(
            self, ctx: frameQLParser.IntervalExpressionAtomContext):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by frameQLParser#existsExpessionAtom.
    def visitExistsExpessionAtom(
            self, ctx: frameQLParser.ExistsExpessionAtomContext):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by frameQLParser#constantExpressionAtom.
    def visitConstantExpressionAtom(
            self, ctx: frameQLParser.ConstantExpressionAtomContext):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by frameQLParser#functionCallExpressionAtom.
    def visitFunctionCallExpressionAtom(
            self, ctx: frameQLParser.FunctionCallExpressionAtomContext):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by frameQLParser#binaryExpressionAtom.
    def visitBinaryExpressionAtom(
            self, ctx: frameQLParser.BinaryExpressionAtomContext):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by
    # frameQLParser#fullColumnNameExpressionAtom.
    def visitFullColumnNameExpressionAtom(
            self, ctx: frameQLParser.FullColumnNameExpressionAtomContext):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by frameQLParser#bitExpressionAtom.
    def visitBitExpressionAtom(
            self, ctx: frameQLParser.BitExpressionAtomContext):
        return self.visitChildren(ctx)
    ...
    def visitTransactionLevelBase(
            self, ctx: frameQLParser.TransactionLevelBaseContext):
        return self.visitChildren(ctx)
    ...
    def visitIntervalTypeBase(
            self,
            ctx: frameQLParser.IntervalTypeBaseContext):
        return self.visitChildren(ctx)
    ...
    def visitFunctionNameBase(
            self,
            ctx: frameQLParser.FunctionNameBaseContext):
        return self.visitChildren(ctx)
