...
class StatementToOprTest(unittest.TestCase):
    @patch("evaoptimizer.statement_to_opr_converter.LogicalGet")
    ...
    @patch("evaoptimizer.statement_to_opr_converter.LogicalFilter")
    ...
    @patch("evaoptimizer.statement_to_opr_converter.LogicalProject")
    ...
    @patch("evaoptimizer.statement_to_opr_converter.LogicalCreateUDF")
    @patch(
        "evaoptimizer.\
...
statement_to_opr_converter.metadata_definition_to_udf_metadata"
    ...
    @patch("evaoptimizer.statement_to_opr_converter.LogicalDropUDF")
    @patch(
        "evaoptimizer.\
statement_to_opr_converter.column_definition_to_udf_io"
    )
