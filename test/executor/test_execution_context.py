...
from evaconstants import NO_GPU
from evaexecutor.execution_context import Context


class ExecutionContextTest(unittest.TestCase):
    @patch("evaexecutor.execution_context.ConfigurationManager")
    @patch("evaexecutor.execution_context.get_gpu_count")
    @patch("evaexecutor.execution_context.is_gpu_available")
    ...
    @patch("evaexecutor.execution_context.ConfigurationManager")
    @patch("evaexecutor.execution_context.os")
    @patch("evaexecutor.execution_context.get_gpu_count")
    @patch("evaexecutor.execution_context.is_gpu_available")
