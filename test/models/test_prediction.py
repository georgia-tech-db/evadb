...
class PredictionTest(unittest.TestCase):
    ...
    def test_should_check_if_batch_frames_equivalent_to_number_of_predictions(self):
        ...
        self.assertRaises(AssertionError,
                          lambda x=None: Prediction.predictions_from_batch_and_lists(batch, predictions, scores))
    ...
    def test_should_return_list_of_predictions_for_each_frame_in_batch(self):
        ...
        self.assertEqual(expected,
                         Prediction.predictions_from_batch_and_lists(batch, predictions, scores
                                                                     ))
