...
from evacatalog.catalog_manager import CatalogManager
from evacatalog.catalog_type import ColumnType, TableType
from evacatalog.catalog_utils import get_video_table_column_definitions
from evacatalog.models.column_catalog import ColumnCatalogEntry
from evacatalog.models.udf_catalog import UdfCatalogEntry
from evaparser.table_ref import TableInfo
...
class CatalogManagerTests(unittest.TestCase):
    ...
    def setUpClass(cls) -> None:
        cls.mocks = [
            mock.patch("evacatalog.catalog_manager.SQLConfig"),
            mock.patch("evacatalog.catalog_manager.init_db"),
        ]
    ...
    @mock.patch(
        "evacatalog.catalog_manager.CatalogManager.create_and_insert_table_catalog_entry"
    )
    ...
    @mock.patch("evacatalog.catalog_manager.init_db")
    @mock.patch("evacatalog.catalog_manager.TableCatalogService")
    ...
    @mock.patch("evacatalog.catalog_manager.init_db")
    @mock.patch("evacatalog.catalog_manager.TableCatalogService")
    @mock.patch("evacatalog.catalog_manager.ColumnCatalogService")
    ...
    @mock.patch("evacatalog.catalog_manager.UdfCatalogService")
    @mock.patch("evacatalog.catalog_manager.UdfIOCatalogService")
    @mock.patch("evacatalog.catalog_manager.UdfMetadataCatalogService")
    @mock.patch("evacatalog.catalog_manager.get_file_checksum")
