...
import os
import sys
sys.path.append("/home/pballapuram3/Eva/faster_rcnn_pytorch/")
sys.path.append("/home/pballapuram3/Eva/faster_rcnn_pytorch/lib")
import numpy as np
import argparse
import pprint
import pdb
...
root_dir="/home/pballapuram3/Eva/faster_rcnn_pytorch"
try:
    xrange          # Python 2
except NameError:
...
def evaluate_inp_from_pp(X,save_to_path=False,path_to_save=None):
    ...
    if args.cfg_file is not None:
        cfg_from_file("/home/pballapuram3/Eva/faster_rcnn_pytorch/"+args.cfg_file)
    if args.set_cfgs is not None:
        cfg_from_list("/home/pballapuram3/Eva/faster_rcnn_pytorch/"+args.set_cfgs)
