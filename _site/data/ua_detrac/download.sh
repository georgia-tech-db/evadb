...
wget --no-check-certificate 'https://detrac-db.rit.albany.edu/Data/DETRAC-train-data.zip'
wget --no-check-certificate 'https://detrac-db.rit.albany.edu/Data/DETRAC-test-data.zip'
