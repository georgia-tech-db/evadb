    ...
    def exec(self, *args, **kwargs) -> Iterator[Batch]:
        ...
        for batch in child_executor.exec(**kwargs):
            ...
            if not res.empty():
                ...
                # This assumes that the batch index is preserved by the function call.
                # Since both the batch and the results are sorted, we could perform a
                # sorted merge, though the typical small size of the batch and results
