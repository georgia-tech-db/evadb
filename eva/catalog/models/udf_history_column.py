...
class UdfHistoryColumn(BaseModel):
    ...
    _history = relationship('UdfHistory',
                            back_populates='_history_cols')

    _col = relationship('DataFrameColumn',
                        back_populates='_udf_history_arg')

    __table_args__ = (
        UniqueConstraint('udf_history_id', 'arg_index'), {}
    )
    ...
    def __eq__(self, other):
        return self.id == other.id and \
            self.udf_history_id == other.udf_history_id and \
