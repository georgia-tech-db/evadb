"""
This file defines the ml base wrapper class and current ml classes that have
been implemented
Feel free to extend the ml models used for filtering by importing contents
of this file
...
class MLBase(metaclass=ABCMeta):
    def __init__(self):
        ...
        # A denotes accuracy (accuracy as in precision - paper shows recalls
