...
class Pipeline:
    ...
    def run(self):
        ...
        self.image_matrix_train, self.image_matrix_test, self.data_table_train, self.data_table_test = self._split_train_val(
    ...
    def train(self):
        ...
        pp_category_stats = self.PP.train_all(self.image_matrix_train,
                                              self.data_table_train)  # TODO: Need to fix this function
    ...
    def execute(self, pp_category_stats, pp_category_models):
        ...
        for query in TRAF_20:
            ...
            best_query, best_operators, reduction_rate = self.QO.run(query, synthetic_pp_list, pp_category_stats,
                                                                     label_desc)
            ...
            if "t=" in query and query in self.data_table_test:
                ...
                print(("Total score for this query is " + str(
                    np.sum(resulting_labels == self.data_table_test[query]) / len(resulting_labels))))
            else:
