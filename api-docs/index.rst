...
If you are wondering why you might need a video database system, start with page on the introduction to ::ref `Video Database Systems <source/overview/video>`. It describes how these systems let users easily make use of deep learning models and how they can reduce money spent on inference on large image or video datasets, and why you should use EVA.
