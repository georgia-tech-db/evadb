...
class RuleType(Flag):
    ...
    COMBINE_WHERE_SIMILARITY_ORDERBY_AND_LIMIT_TO_FILTERED_VECTOR_INDEX_SCAN = auto()
    ...
    LOGICAL_CREATE_FUNCTION_TO_PHYSICAL = auto()
    LOGICAL_CREATE_FUNCTION_FROM_SELECT_TO_PHYSICAL = auto()
